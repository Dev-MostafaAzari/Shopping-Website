                        ...
                        <div className="w-full h-full flex flex-col lg:flex-row p-[10px] gap-[20px]">
                                ...
                                <div className="w-full h-full flex flex-col gap-[5px]">
                                    <div className="flex-3 flex justify-center items-center relative">
                                        <div className="w-[200px] lg:w-[400px] xl:w-[500px] h-full overflow-hidden">
                                            <motion.div style={width >=1280 ? {width:`${product?.images.length*500}px`} : width>=1024 ? {width:`${product?.images.length*400}px`} : {width:`${product?.images.length*200}px`}}  animate={width >=1280 ? {translateX:slide*500} : (width >=1024 ? {translateX:slide*400} : {translateX:slide*200})} transition={{duration:0.5}} className={`h-full flex`}>
                                                {product?.images.map((item,index)=>(
                                                    <div key={index} className="p-[10p] w-[200px] lg:w-[400px] xl:w-[500px] h-full flex justify-center items-center">
                                                        <Image key={index} src={item} alt="productPic" quality={100} width={300} height={100} className="w-[200px] lg:w-[400px] xl:w-[500px] h-auto"/>
                                                    </div>
                                                ))}
                                            </motion.div>
                                        </div>
                                        <button className="absolute top-[10px] left-[10px] xl:left-[20px] 2xl:left-[50px] text-gray-400 text-[16px] cursor-pointer"><FontAwesomeIcon icon={faHeart}/></button> {/* reminder : add to favorite in progress ... */}
                                    </div>
                                    <div className="flex-1">
                            ...
                            <div className="flex-1">
                                <div className="w-full h-full flex flex-col gap-[10px] xl:w-[70%] xl:gap-[15px] 2xl:w-[60%] 2xl:items-center 2xl:gap-[20px]">
                                    ...
                                    <div className="w-full h-full flex gap-[10px] justify-between md:justify-around p-[10px]">
                                        <div className="flex items-center">
                                            <button className="text-stone-50 text-[16px] border-1px rounded-xl bg-sky-700 p-[10px] cursor-pointer hover:bg-sky-900">افزودن به سبدخرید</button>
                                        </div>
                    ...
                    <div className="flex-1">
                        <div className="w-full flex flex-col gap-[10px]">
                            <div className="flex w-full justify-evenly items-center">
                                <motion.button onClick={()=>{setActiveTap(0)}} className={`p-[10px] ${activeTab===0 ? "text-gray-700":"text-gray-400 cursor-pointer"} relative`}>مشخصات 
                                ...
                                <motion.button onClick={()=>{setActiveTap(1)}} className={`p-[10px] ${activeTab===1 ? "text-gray-700":"text-gray-400 cursor-pointer"} relative`}>جزئیات محصول 
                                ...
                                <motion.button onClick={()=>{setActiveTap(2)}} className={`p-[10px] ${activeTab===2 ? "text-gray-700":"text-gray-400 cursor-pointer"} relative`}>نظرات 
                            ...
                            {/* reviews part*/}               
                            <div className={`w-full p-[10px] gap-[10px] md:gap-[15px] ${activeTab === 2 ? "flex flex-col" : "hidden"}`}>
                                {product?.reviews.map((item,index)=>(
                                    <div key={index} className="w-full p-[10px]">
                                        <div className="w-full flex justify-right gap-[10px] relative">
                                            ...
                                            <div className="absolute top-[5px] left-[5px] text-gray-700 text-[8px] md:text-[12px]">{item.date}</div>
                                        </div>
                                        <div className="w-full flex items-center text-gray-500 text-pretty text-[12px] md:text-[16px]" >
                                            <p dir="ltr">{item.comment}</p>
                                        </div>
                                    </div>
                                ))}
                            </div>                
