            ...
            <div className="h-[100px] flex justify-evenly items-center bg-white ">
                ...
                <div className="">
                    <div className="relative">
                        <input className="bg-gray-100 border-[1px] border-gray-300 w-[300px] md:w-[520px] rounded-lg text-right p-[5px] outline-none" type="text" placeholder="جستجو در محصولات ..." />
