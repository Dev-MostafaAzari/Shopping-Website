    ...
    return (
        <div className="w-full flex justify-center items-center ">
            <div className="w-full flex flex-col gap-[20px] p-[10px]">
                <div className="w-full flex justify-center items-center">
                    <div className="w-full lg:w-[1566px] flex justify-center items-center lg:px-[20px]">
                ...
                <div className="w-full flex justify-center items-center">
                    <div className="w-full lg:w-[1366px] grid grid-cols-3 lg:grid-cols-6 text-gray-500 text-xs gap-[10px] lg:gap-[0px] lg:text-sm ">
