...
const NotFound = () => {
    return (
        <div className="w-screen overflow-x-hidden ovarflow-y-scroll lg:scrollbar-none md:h-[calc(100vh-100px)] lg:h-[calc(100vh-200px)] h-[calc(100vh-164px)] flex justify-center items-center">
            <div className="flex flex-col justify-center items-center gap-[10px] lg:text-[20px] p-[10px]">
                <Image src={error} quality={100} alt="error404" loading="eager"/>
                <p className="text-gray-600">متاسفانه صفحه موردنظر یافت نشد</p>
